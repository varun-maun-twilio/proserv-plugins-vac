...
const useActivityAPI = ( initialParams = {}, itemsPerPage = 50) => {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
        const endPoint = fetchEndpoint('/features/bulk-skills-mapper/flex/search-activities');
      ...
      const {meta,activities} = await response.json();
