...
export const componentHook = function addParkButton(flex: typeof Flex) {
  flex.TaskCanvasHeader.Content.add(<ParkButton key="park-button" />, {
    sortOrder: 1,
    if: (props) => Flex.TaskHelper.isCBMTask(props.task) && (props.task.attributes.externalSource=='airbnb' || props.task.attributes.externalSource=='bdc' ) && props.task.taskStatus === 'assigned',
  });
